...
import com.grappenmaker.coachtaal.cli.CliLanguage
...
fun Path.projectConfig() = resolve("project.json")
fun Path.loadProject() = Project(this, json.decodeFromString(projectConfig().readText()))
...
data class ProjectConfig(
    val language: CliLanguage = CliLanguage.DUTCH,
